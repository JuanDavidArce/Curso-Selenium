...
class TestingMercadoLibre(unittest.TestCase):
	...
	def test_search_PS4(self):
		...
		location = driver.find_element_by_xpath('//*[@id="root-app"]/div/div/aside/section/dl[8]/dd[1]/a/span[1]')
		driver.execute_script("arguments[0].click();", location)
		sleep(3)

		condition = driver.find_element_by_xpath('//*[@id="root-app"]/div/div/aside/section[2]/dl[6]/dd[1]/a/span[1]')
		...
		higher_price = driver.find_element_by_xpath('//*[@id="root-app"]/div/div/section/div[1]/div/div/div/div[2]/div/div/div/ul/li[3]/a/div/div')
